    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Gallery Image Management</h4>
                        <p class="card-description"> Add/ Update Gallery Image Content </p>
                        ...
                        <form class="forms-sample" id="newFrmId" name="newFrmName" method="POST" action="#"
                            ...
                            <button type="button" class="btn btn-danger mr-2"
                                onclick="window.location.href='{{ route('adminGalleryPicture') }}'"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#newFrmId').submit(function() {
                ...
                $('#proccedtologin').show();
                $.ajax({
                    url: "{{ route('adminGalleryPictureDataSubmit') }}",
                    data: formData,
                    type: 'post',
                    cache: false,
                    processData: false,
