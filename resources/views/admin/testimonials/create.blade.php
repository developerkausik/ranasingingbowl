            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description"> Add/ Update Testimonial Content </p>
                        ...
                        <form class="forms-sample" id="newFrmId" name="newFrmName" method="POST" action="#"
                            ...
                            <button type="button" class="btn btn-danger mr-2"
                                onclick="window.location.href='{{ route('adminTestimonials') }}'"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#newFrmId').submit(function() {
                ...
                $('#proccedtologin').show();
                $.ajax({
                    url: "{{ route('adminTestimonialsDataSubmit') }}",
                    data: formData,
                    type: 'post',
                    cache: false,
                    processData: false,
