                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <a class="btn-sm btn-dark btn-icon-text float-end"
                                    href="{{ route('adminTestimonialsAdd') }}"><i class="icon-plus"></i>
                                    Add New</a>
                            </div>
                        </div>
                        <p id="msg">
                                    ...
                                    @if (isset($result) && !empty($result))
                                        @foreach ($result as $key => $val)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ route('adminTestimonialsUpdate', Crypt::encryptString($edit_id)) }}" class="btn btn-otline-info text-info"><i class="icon-pencil"></i> Edit</a></td>
        ...
        $(document).ready(function() {
            $('#dataTable').on('click', '.delete', function() {
                ...
                if (msg == true) {
                    ...
                    $('#proccedtologin').show();
                    $.ajax({
                        url: "{{ route('adminTestimonialsDelete') }}",
                        data: {
                            'id': id
                        },
                        type: 'post',
