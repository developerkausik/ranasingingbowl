        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-9"><h4 class="card-title">List of Banners</h4></div>
                            <div class="col-sm-3">
                                <a class="btn-sm btn-dark btn-icon-text float-end" href="{{ route('adminBannerAdd') }}"><i
                                        class="icon-plus"></i>
                                    Add New</a>
                            </div>
                        </div>
                                    ...
                                    @if (isset($banner) && !empty($banner))
                                        @foreach ($banner as $key => $val)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('adminBannerUpdate', Crypt::encryptString($edit_id)) }}"
