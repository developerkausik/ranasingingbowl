        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-9"><h4 class="card-title">List of SEO Data</h4></div>
                            <div class="col-sm-3">
                                <a class="btn-sm btn-dark btn-icon-text float-end" href="{{ route('adminSeoAdd') }}"><i
                                        class="icon-plus"></i>
                                    Add New</a>
                            </div>
                        </div>
                                    ...
                                    @if (isset($seo) && !empty($seo))
                                        @foreach ($seo as $key => $val)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $val->current_url }}</td>
                                                <td>{{ $val->title }}</td>
                                                <td>
                                                    <a href="{{ route('adminSeoUpdate', Crypt::encryptString($edit_id)) }}"
