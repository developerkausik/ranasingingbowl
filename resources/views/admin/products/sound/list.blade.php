    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Product Sound Management</h4>
                        <p class="card-description"> Add/ Update Sound of {{ $product->title }} </p>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-9">
                                <h4 class="card-title">List of Sounds for {{ $product->title }}</h4>
                            </div>
                            {{-- <div class="col-sm-3">
                                    ...
                                    @if (isset($result) && !empty($result))
                                        @foreach ($result as $key => $val)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ route('adminProductSoundUpdate', [Crypt::encryptString($product->id), Crypt::encryptString($edit_id)]) }}"
        ...
        $(document).ready(function() {
            $('#dataTable').on('click', '.delete', function() {
                ...
                if (msg) {
                    ...
                    $('#proccedtologin').show();
                    $.ajax({
                        url: "{{ route('adminProductSoundDelete') }}",
                        data: {
                            id: id
                        },
                        type: 'post',
            ...
            $('#newFrmId').submit(function() {
                ...
                $('#proccedtologin').show();
                $.ajax({
                    url: "{{ route('adminProductSoundDataSubmit') }}",
                    data: formData,
                    type: 'post',
                    cache: false,
                    processData: false,
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function() {
                            var url =
                                "{{ route('adminProductSound', ['id' => 'ID_PLACEHOLDER']) }}";
