    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Product Image Management</h4>
                        <p class="card-description"> Add/ Update Image of {{ $product->title }} </p>
                        ...
                        <form class="forms-sample" id="newFrmId" name="newFrmName" method="POST" action="#"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="product_code" name="product_code"
                                    ...
                                    value="@if(isset($image->product_code) && $image->product_code != ''){{ $image->product_code }}@else{{ old('product_code') }}@endif">
                            </div>
                            <div class="form-group">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-9">
                                <h4 class="card-title">List of Images for {{ $product->title }}</h4>
                            </div>
                            {{-- <div class="col-sm-3">
                                    ...
                                    @if (isset($result) && !empty($result))
                                        @foreach ($result as $key => $val)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ route('adminProductImageUpdate', [Crypt::encryptString($product->id), Crypt::encryptString($edit_id)]) }}"
        ...
        $(document).ready(function() {
            $('#dataTable').on('click', '.delete', function() {
                ...
                if (msg) {
                    ...
                    $('#proccedtologin').show();
                    $.ajax({
                        url: "{{ route('adminProductImageDelete') }}",
                        data: {
                            id: id
                        },
                        type: 'post',
            ...
            $('#newFrmId').submit(function() {
                ...
                $('#proccedtologin').show();
                $.ajax({
                    url: "{{ route('adminProductImageDataSubmit') }}",
                    data: formData,
                    type: 'post',
                    cache: false,
                    processData: false,
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function() {
                            var url =
                                "{{ route('adminProductImage', ['id' => 'ID_PLACEHOLDER']) }}";
